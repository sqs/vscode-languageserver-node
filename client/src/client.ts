...
function createConnection(stream: MessageStream, errorHandler: ConnectionErrorHandler, closeHandler: ConnectionCloseHandler): IConnection {
	let logger = new ConsoleLogger();
	let connection = createMessageConnection(stream.reader, stream.writer, logger);
